...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
			...
			RenderSettings.fogColor = new Color (0.2f, 0.4f, 0.5f, 0.4f); // r, g, b, Transparency 
		...
		bool IsInWater()
		{
			return gameObject.transform.position.y < 16.2f;
		}
		...
		bool IsUnderWater()
		{
			return gameObject.transform.position.y < 15.1f;
		}

		public bool IsNearWater()
		{
			return gameObject.transform.position.y < 21.0f;
		}
        ...
        private void Update()
        {
			...
			if (IsInWater ()) 
			{
				...
				{
					if(AbleToMoveUp() && Input.GetKey(KeyCode.LeftShift))
